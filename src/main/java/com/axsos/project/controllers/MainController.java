...
public class MainController {
	...
	public String submitContactForm(@Valid @ModelAttribute("contact") Contact contact, BindingResult result,
	    ...
	    try {
	        ...
	        model.addAttribute("errorMessage", "There was a problem processing your request. Please try again later.");
	        return "contact.jsp"; // Return to the form with an error message
	    }
