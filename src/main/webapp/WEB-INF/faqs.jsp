 ...
 <section id="banner" class="py-3" style="background: #F9F3EC;">
    <div class="container">
      <div class="hero-content py-5 my-3">
        <h2 class="display-1 mt-3 mb-0">Pet Adoption<span class="text-primary"> FAQs</span> </h2>
        <nav class="breadcrumb">
          <a class="breadcrumb-item nav-link" href="#">Home</a>
          <a class="breadcrumb-item nav-link" href="#">Pages</a>
          <span class="breadcrumb-item active" aria-current="page">Pet Adoption FAQs</span>
        </nav>
      </div>
    </div>
  </section>
    ...
    <div class="container py-5 my-5">
      <div class="row my-4">
        <main class="col-md-8 pe-5">
          ...
          <p>If you're considering adopting a pet, here are some common questions and answers to help you understand the process better.</p>
              ...
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne">
                  <div class="accordion-body secondary-font">
                    Adopting a pet typically involves visiting a shelter, filling out an application, meeting with potential pets, and completing an adoption fee.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
                  <div class="accordion-body secondary-font">
                    Requirements often include proof of identity, proof of residence, and sometimes references from a veterinarian or landlord.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <h5> Are the pets vaccinated and spayed/neutered before adoption? </h5>
                  </button>
                </h2>
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree">
                  <div class="accordion-body secondary-font">
                    Yes, most pets available for adoption are vaccinated and spayed/neutered. This ensures their health and prevents overpopulation.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour">
                  <div class="accordion-body secondary-font">
                    Adoption fees vary but typically range from $50 to $200. These fees help cover the costs of caring for the pet before adoption.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive">
                  <div class="accordion-body secondary-font">
                    Consider your lifestyle, time commitment, and financial ability to care for a pet. Ensure your home is pet-friendly and you have enough space.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix">
                  <div class="accordion-body secondary-font">
                    Yes, many shelters allow pet adoption for apartment dwellers. However, some may have specific guidelines regarding pet size or breed.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="inquiry-item col-md-4">
          ...
          <p>Have more questions? Contact us for more information about pet adoption.</p>
