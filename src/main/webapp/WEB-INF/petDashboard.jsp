...
<body>
	...
	<img src="<spring:url value='/images/cat.png' />" alt="Cat"> 
		...
		<a href="/pet/dashboard"><i class="fas fa-tachometer-alt"></i>
			Dashboard</a> <a href="/shop/home"><i class="fas fa-store"></i>
			Pets</a> <a href="/shop/add"><i class="fas fa-plus-circle"></i> Add
			a Pet</a> <a href="/logout"><i class="fas fa-sign-out-alt"></i>
			Logout</a>
		</div>
	</div>
