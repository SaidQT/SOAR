	...
	<section id="banner" class="py-3" style="background: #F9F3EC;">
		<div class="container">
			<div class="hero-content py-5 my-3">
				<h2 class="display-1 mt-3 mb-0">Our Partners</h2>
				<nav class="breadcrumb">
					<a class="breadcrumb-item nav-link" href="#">Home</a> <a
						class="breadcrumb-item nav-link" href="#">Pages</a>
				</nav>
			</div>
		</div>
	</section>
	...
	<section id="foodies" class="my-5">
		<div class="container my-5 py-5">
			<div
				...
				<h2 class="display-3 fw-normal">Shops</h2>
			</div>
				...
				<c:forEach var="shop" items="${shops}">
					<div class="col-md-4 col-lg-3 my-4">
						<div class="card position-relative">
							<img
								src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKMVdA2sExDt1td_vfeDxtVEqYdJBIT0MaBw&s"
								alt="image">
							<div class="card-body p-0">
								<a href="single-product.html">
									<h3 class="card-title pt-4 m-0">
										<c:out value="${shop.name}"></c:out>
									</h3>
								</a>
								<div class="card-text">
									<h3 class="secondary-font text-primary">
										<c:out value="${shop.city}"></c:out>
									</h3>
								</div>
							</div>
						</div>
