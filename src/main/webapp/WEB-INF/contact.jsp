    ...
    <div class="container py-5 my-5">
      <div class="row">
        ...
        <div class="contact-info col-lg-6 pb-3">
         <img src="images/banner-img.png" alt="cute" style="height: 100% ; object-fit: cover;width: 72%;">
        </div>
        ...
        <div class="inquiry-item col-lg-6">
          <div class="rounded-5">
            ...
            <form:form method="post" action="${pageContext.request.contextPath}/contact" modelAttribute="contact">
            
              <div class="form-input col-lg-12 d-flex mb-3">
                <form:input path="name"  type="text" name="email" placeholder="Write Your Name Here" class="form-control ps-3 me-3"/>
                <form:errors path="name" cssClass="error" />
                
                <form:input path="email" type="text" name="email" placeholder="Write Your Email Here" class="form-control ps-3"/>
                <form:errors path="email" cssClass="error" />
                
              </div>
              <div class="col-lg-12 mb-3">
                <form:input path="phone" type="text" name="email" placeholder="Phone Number" class="form-control ps-3"/>
				<form:errors path="phone" cssClass="error" />              
              </div>
              
              <div class="col-lg-12 mb-3">
                <form:input path="subject" type="text" name="email" placeholder="Write Your Subject Here" class="form-control ps-3"/>
                <form:errors path="subject" cssClass="error" />
              </div>
              <div class="col-lg-12 mb-3">
                <form:textarea path="message" placeholder="Write Your Message Here" class="form-control ps-3"
                  style="height:150px;"/>
